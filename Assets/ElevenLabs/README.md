...
- **Voice History**: View and retrieve past generations.
- **ZIP Export**: Export generated audio as a ZIP archive.

## Quick Start
1. Go to `Window > Voice Over` in the Unity Editor menu.
2. In Settings, select your Active Provider (ElevenLabs or Sarvam AI) and enter your API Key.
3. Click `+ New Module` and start adding text steps.
4. Click Generate Audio to create your `.wav` files perfectly structured in the project!
