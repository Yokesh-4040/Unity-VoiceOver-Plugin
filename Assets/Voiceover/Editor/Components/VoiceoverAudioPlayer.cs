...
namespace FF.Voiceover.Editor.Components
{
    public class VoiceoverAudioPlayer
    {
        ...
        public VoiceoverAudioPlayer(EditorWindow window)
        {
        ...
        public void DrawBottomPlayer(float width, float height)
        {
            ...
            GUILayout.BeginArea(playerRect, VoiceoverEditorStyles.ContentStyle);
        ...
        public void LoadAudio(AudioClip clip, string title, bool autoPlay = false)
        {
            if (clip == null) 
            {
                Debug.LogWarning("[Voiceover] Cannot load null audio clip");
                return;
            }
        ...
        private void StopAllClips()
        {
            ...
            {
                Debug.LogError($"[Voiceover] Failed to stop audio clips: {e.Message}");
            }
        }
        ...
        private void PlayClip(AudioClip clip, int startSample = 0, bool loop = false)
        {
            ...
            {
                Debug.LogError($"[Voiceover] Failed to play audio clip: {e.Message}");
            }
        }
        ...
        private bool IsClipPlaying()
        {
            ...
            {
                Debug.LogError($"[Voiceover] Failed to check if clip is playing: {e.Message}");
                return false;
            }
        }
        ...
        private void SaveCurrentClip()
        {
            ...
            string folderName = "Assets/Voiceover/GeneratedVoices";
